...
# =============================================================================
# =============================================================================
#from arkania.model import CocoConv
#from arkania.utils import get_experience, get_state
#from arkania import SimpleEnv
# =============================================================================
from model import CocoConv
from utils import get_experience
...
def get_state(state_dict):
    ...
    return state_dict['sight'].reshape((-1,1,13,13))

#Create net
net_size  = 800
net       = CocoConv(net_size).cuda()
...
for episode in range(1000000):
    ...
    while not done:
        ...
        reward                     += (new_state['health'] + new_state['energy'] \
                                        + new_state['food'] + new_state['water'])/100
        new_state                  = get_state(new_state)
        
        #collect experience
        experience.append((state[0], action, reward))
